...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("0452e4b2ee0a9492352e6afc76cece5b8b191cc553f9bfb080074f34a80192aecf8621c6b7eb780339432fd716cd1263341f9eb9d07267c4a1dc7fb610f747a708");
        nDefaultPort = 21237;
        nRPCPort = 21238;
        ...
        //
        // CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=4a5e1e, nTime=1502541577, nBits=1d00ffff, nNonce=0, vtx=1)
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1502541577;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 2033359488;
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("041e105db7af03e5fa99d4dbd44b44df06ceb8162c21428298f890d7189db23ac6952e8f3aa50af4024152b761d3469ead153cefd83c1dc3f5f033d43fbd33b021");
        nDefaultPort = 31237;
        nRPCPort = 31238;
        strDataDir = "testnet3";
